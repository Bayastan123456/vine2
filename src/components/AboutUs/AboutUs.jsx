    ...
    <div className="aboutUs">
        ...
        <div className='aboutUs_container'>
            ...
            <div className="article">
                <a href="https://www.cucinaevini.it/villa-franciacorta-il-coraggio-di-emozione-unica/">
            ...
            <div className="article">
                <a href="https://www.bubblesitalia.com/le-emozioni-di-villa-franciacorta/">
                    <div className="aboutUs_line">
                        <div className="aboutUs_bg"></div>
                        <div className='aboutUs_lineImg'>
            ...
            <div className="article">
                <a href="https://www.jamesmagazine.it/franciacorta/villa-franciacorta-la-perfezione-dei-nuovi-millesimi/">
                    <div className="aboutUs_line">
                        <div className="aboutUs_bg"></div>
                        <div className='aboutUs_lineImg'>
            ...
            <div className="article">
                <a href="https://www.italiaatavola.net/vino/cantine-consorzi/2023/4/3/villa-franciacorta-ottime-nuove-annate-2018-da-non-perdere-emozione-unica-2017/95480/">
                    <div className="aboutUs_line">
                        <div className="aboutUs_bg"></div>
                        <div className='aboutUs_lineImg'>
            ...
            <div className="article">
                <a href="https://horecanews.it/villa-franciacorta-presenta-i-nuovi-millesimi/">
                    <div className="aboutUs_line">
                        <div className="aboutUs_bg"></div>
                        <div className='aboutUs_lineImg'>
            ...
            <div className="article">
                <a href="https://www.corrierenazionale.it/2023/02/10/i-vini-di-villa-franciacorta-continuano-la-crescita-nel-mondo/">
                    <div className="aboutUs_line">
                        <div className="aboutUs_bg"></div>
                        <div className='aboutUs_lineImg'>
